...
declare namespace ts.server {
    ...
    abstract class Project implements LanguageServiceHost, ModuleResolutionHost {
        ...
        getRootFilesMap(): Map<ProjectRootFile>;
    ...
    class InferredProject extends Project {
        ...
        constructor(projectService: ProjectService, documentRegistry: DocumentRegistry, compilerOptions: CompilerOptions, watchOptions: WatchOptions | undefined, projectRootPath: NormalizedPath | undefined, currentDirectory: string | undefined, pluginConfigOverrides: Map<any> | undefined);
    ...
    class ConfiguredProject extends Project {
        ...
        openFileWatchTriggered: Map<true>;
    ...
    class ExternalProject extends Project {
        ...
        private typeAcquisition;
        constructor(externalProjectName: string, projectService: ProjectService, documentRegistry: DocumentRegistry, compilerOptions: CompilerOptions, lastFileExceededProgramSize: string | undefined, compileOnSaveEnabled: boolean, projectFilePath?: string, pluginConfigOverrides?: Map<any>, watchOptions?: WatchOptions);
        updateGraph(): boolean;
        getExcludedFiles(): readonly NormalizedPath[];
        getTypeAcquisition(): TypeAcquisition;
        setTypeAcquisition(newTypeAcquisition: TypeAcquisition): void;
...
declare namespace ts.server {
    ...
    export class ProjectService {
        ...
        sendUpdateGraphPerformanceEvent(durationMs: number): void;
        ...
        loadAncestorProjectTree(forProjects?: ReadonlyMap<true>): void;
